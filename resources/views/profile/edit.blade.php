        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-[#161615] shadow sm:rounded-lg">
                <div class="max-w-xl">
                    ...
                    <button id="theme-toggle" onclick="toggleTheme()" class="px-4 py-2 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-900 dark:text-white rounded-lg transition flex items-center gap-2">
