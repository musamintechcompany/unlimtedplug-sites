                    ...
                    <a href="{{ route('projects.show', $project->id) }}" class="bg-white dark:bg-[#161615] rounded-2xl overflow-hidden border-2 border-blue-400/20 dark:border-blue-500/20 hover:border-blue-400 dark:hover:border-blue-500 hover:shadow-xl transition block">
                        <div class="h-48 bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center overflow-hidden">
                            ...
                            @elseif(!empty($project->media_images) && count($project->media_images) > 0)
                                <img src="{{ asset('storage/' . $project->media_images[0]) }}" alt="{{ $project->name }}" class="w-full h-full object-cover">
                            @else
    ...
    <section class="py-16 md:py-24 bg-gradient-to-br from-gray-50 to-gray-100">
        <div class="max-w-7xl mx-auto px-4">
            <div class="text-center mb-12 md:mb-16">
                <h2 class="text-3xl md:text-5xl font-bold text-gray-900 mb-4 opacity-0" data-animation="animate-fade-in-down" data-animation-delay="0">Why Rent With Us?</h2>
                <p class="text-gray-600 text-lg max-w-2xl mx-auto opacity-0" data-animation="animate-fade-in-up" data-animation-delay="1">Everything you need to launch your online presence in minutes</p>
            </div>
            <div class="grid md:grid-cols-3 gap-6 md:gap-8">
                <!-- Card 1 -->
                <div class="group bg-white rounded-2xl p-8 transition duration-300 border border-gray-100 hover:border-indigo-200 opacity-0" data-animation="animate-slide-in-left" data-animation-delay="0">
                ...
                <!-- Card 2 -->
                <div class="group bg-white rounded-2xl p-8 transition duration-300 border border-gray-100 hover:border-green-200 opacity-0" data-animation="animate-slide-in-right" data-animation-delay="1">
                ...
                <!-- Card 3 -->
                <div class="group bg-white rounded-2xl p-8 transition duration-300 border border-gray-100 hover:border-purple-200 opacity-0" data-animation="animate-slide-in-left" data-animation-delay="2">
            ...
            <div class="grid md:grid-cols-4 gap-4 mt-8">
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 opacity-0" data-animation="animate-fade-in-up" data-animation-delay="3">
                    <div class="text-2xl font-bold text-indigo-600 mb-1">99.9%</div>
                    <p class="text-sm text-gray-600">Uptime Guarantee</p>
                </div>
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 opacity-0" data-animation="animate-fade-in-up" data-animation-delay="4">
                    <div class="text-2xl font-bold text-green-600 mb-1">24/7</div>
                    <p class="text-sm text-gray-600">Support Available</p>
                </div>
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 opacity-0" data-animation="animate-fade-in-up" data-animation-delay="5">
                    <div class="text-2xl font-bold text-purple-600 mb-1">∞</div>
                    <p class="text-sm text-gray-600">Scalable Solutions</p>
                </div>
                <div class="bg-white rounded-xl p-4 text-center border border-gray-100 opacity-0" data-animation="animate-fade-in-up" data-animation-delay="6">
