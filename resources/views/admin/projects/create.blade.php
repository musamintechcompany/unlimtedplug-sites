                            ...
                            <div class="space-y-4">
                                ...
                                <div class="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition">
                                    ...
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" name="is_buyable" value="1" {{ (isset($project) && $project->details ? json_decode($project->details, true)['is_buyable'] ?? false : false) ? 'checked' : '' }} class="sr-only peer">
