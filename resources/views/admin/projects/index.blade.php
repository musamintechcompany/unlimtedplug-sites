                        ...
                        <table class="w-full border-collapse">
                            <thead>
                                <tr class="bg-gradient-to-r from-indigo-600 to-indigo-700 text-white">
                                    ...
                                    <th class="px-4 py-4 text-left text-sm font-semibold border-r border-indigo-500">Type</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                @foreach($projects as $project)
                                    @php
                                        ...
                                        $isBuyable = $details['is_buyable'] ?? false;
                                        $isRentable = $details['is_rentable'] ?? false;
                                    @endphp
                                    <tr class="hover:bg-gray-50 transition">
                                        <!-- Image -->
                                        <td class="px-4 py-4 border-r border-gray-200 w-20">
                                            @if($firstImage)
                                                <img src="{{ asset($firstImage) }}" alt="{{ $project->name }}" class="w-16 h-16 object-cover rounded-lg">
                                            @else
                                        ...
                                        <!-- Type -->
                                        <td class="px-4 py-4 border-r border-gray-200 max-w-xs">
                                            <span class="inline-block bg-indigo-100 text-indigo-700 px-2 py-1 rounded text-xs font-medium truncate" title="{{ $project->type }}">
                                                {{ $project->type }}
                                            </span>
                                        </td>
